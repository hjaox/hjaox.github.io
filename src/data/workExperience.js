export const workExperience = {
  "Golden Sky Trading & Engineering Services WLL": {
    ...
    info: [
      "Design and fabricate Motor Control Center Panels (MCP",
  ...
  "First Oceanic Property Management Inc.": {
    ...
    info: [
      "Ensures the smooth flowing and efficiency of operation of the building equipment",
  ...
  "Clippers Logistics (PE3) under Staffing Match Agency": {
    ...
    info: [
      "Allocating orders for E-commerce and Retail customers",
  ...
  "SUEZ Water Technologies and Solutions UK L P": {
    ...
    info: [
      "Ensuring the quality (QC) of different types of water treatment equipment (Deionization & Reverse Osmosis). This can include mechanical and electrical jobs",
  ...
  Northcoders: {
    ...
    date: "",
    info: [
      "During the 13-week Bootcamp where I learned the fundamentals of Full-Stack Development, I acquired the fundamentals of JavaScript which helped me in creating a back-end service to provide data for a front-end architecture that I have built. \n\n All throughout the process, I aimed to build clean testable codes by following Test Driven Development process with agile methodologies while both working solo or working with colleagues through pair-programming or in group projects",
    ],
  },
};
