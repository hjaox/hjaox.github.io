export const projects = {
    'NC News Backend Project': {
        info: 'A RESTful API backend project that would serve data of articles and other related information to the frontend project that I built. The purpose or this repository is to learn how to build an API for accessing application data programmatically and to mimic the building of a real-world backend service.',
        tech: ['JavaScript', 'PostgreSQL', 'Express', 'Jest', 'Supertest', 'node-Postgres'],
        sourceCode: 'https://github.com/hjaox/be-nc-news',
        appLink: null,
        preview: '../media/test.jpg',
        shortVid: ''
    },
