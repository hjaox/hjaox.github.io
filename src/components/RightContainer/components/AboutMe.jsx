export default function AboutMe() {
    return (
        <section id="about" className="scroll-mt-24">
            ...
            <p>
            My current focus is acquiring new skills and developing my proficiency on certain languages and libraries/frameworks to be able to make exciting and more complex projects.
            </p>
        </section>
    )
}